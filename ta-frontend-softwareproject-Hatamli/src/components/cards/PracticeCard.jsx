import {
  ...
  const PracticeCard = ({ img }) => {
    return (
      <Card sx={{ boxShadow:"none" }} className="relative shadow-none">
        <New/>
        ...
        <div className="px-4">
          <CardContent>
            ...
            <Typography
              className="font-montserrat !text-[16px] !font-bold leading-5 text-[#252B42]"
              gutterBottom
              variant="h5"
              component="div"
            >
          ...
          <CardActions>
            <Button className="!font-bold !capitalize !text-[#737373]" size="small">
              Learn More{" "}
